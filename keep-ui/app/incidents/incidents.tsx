...
import { IncidentsEmptyState } from "./ui/IncidentsEmptyState";
...
export function Incidents() {
  ...
  function renderPredictedIncidents() {
    if (
      isPredictedLoading ||
      !predictedIncidents ||
  ...
  console.log({
    isLoading,
    incidents,
    "incidents.items.length": incidents?.items.length,
  });
  ...
  function renderIncidents() {
    ...
    return <IncidentsEmptyState setIsFormOpen={setIsFormOpen} />;
  }

  return (
    <div className="flex h-full w-full">
      <div className="flex-grow min-w-0">
        {renderPredictedIncidents()}
        ...
        <div className="h-full flex flex-col gap-5">
          ...
          <Card className="flex-grow">{renderIncidents()}</Card>
        </div>
      </div>
      <Modal
        isOpen={isFormOpen}
